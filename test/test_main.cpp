...
TEST(BulkTest, BulkTest1)
{
	...
	std::string tested = GetTestResult(1);
...
TEST(BulkTest, BulkTest2)
{
	...
	std::string tested = GetTestResult(2);
	ASSERT_EQ(tested, control);
}
...
TEST(BulkTest, BulkTest3)
{
	...
	std::string tested = GetTestResult(3);
	ASSERT_EQ(tested, control);
}
...
TEST(BulkTest, BulkTest4)
{
	...
	std::string tested = GetTestResult(4);
	ASSERT_EQ(tested, control);
}
